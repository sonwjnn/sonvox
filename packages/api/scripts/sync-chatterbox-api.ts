...
const OUTPUT_PATH = path.resolve(__dirname, "../src/types/chatterbox.d.ts");
...
async function main() {
	...
	// Add header comment
	const header = `/**
 * This file is auto-generated by scripts/sync-chatterbox-api.ts
 * Do not edit manually. Run \`bun run sync:api\` to regenerate.
 *
